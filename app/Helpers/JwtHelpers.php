...
class JwtHelpers
{
    ...
    public function validateToken($token)
    {
        try {
            ...
            throw new JwtException('The access token expired', 401);
        } catch (\Firebase\JWT\SignatureInvalidException $e) {
            Log::debug('Error JwtHelpers validateToken:', ['error' => $e->getMessage()]);
            throw new JwtException('The access token is not valid', 401);
        } catch (\Exception $e) {
